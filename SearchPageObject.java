...
public class SearchPageObject extends MainPageObject{
    private static final String
            ...
            SEARCH_RESULT_BY_SUBSTRING_TITLE_AND_DESCRIPTION_TPL = "//androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.TextView[contains(@text, '{TITLE}')]/../android.widget.TextView[contains(@text, '{DESCRIPTION}')]";
   ...
   public void waitForElementByTitleAndDescription(String title, String description)
   {
       ...
       for(int i = 1; i <= 3; i++)
       {
           WebElement element = this.waitForElementPresent(
                   By.xpath(search_result_xpath.replace("1", Integer.toString(i))),
